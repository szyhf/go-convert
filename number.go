				...
				if resU64, erro := strconv.ParseUint(valueString, 0, 0); erro != nil {
					if resF64, erro := strconv.ParseFloat(valueString, 0); erro != nil {
						if resBool, erro := strconv.ParseBool(valueString); erro != nil {
							...
							res = MustInt32(resBool)
						}
					} else {
						res = MustInt32(resF64)
					}
				} else {
					res = MustInt32(resU64)
				}
				...
				if resU64, erro := strconv.ParseUint(valueString, 0, 0); erro != nil {
					if resF64, erro := strconv.ParseFloat(valueString, 0); erro != nil {
						if resBool, erro := strconv.ParseBool(valueString); erro != nil {
							...
							res = MustInt64(resBool)
						}
					} else {
						res = MustInt64(resF64)
					}
				} else {
					res = MustInt64(resU64)
				}
...
func ConverStringToIntSlice(value, sep string) []int {
	data := strings.Split(value, sep)
	var result []int
	for _, v := range data {
...
func ConverStringToStringSlice(value, sep string) []string {
	data := strings.Split(value, sep)
	var result []string
	for _, v := range data {
